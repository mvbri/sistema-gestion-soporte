-- Backup generado el 2026-04-30T04:10:00.082Z
...
CREATE TABLE `material_requests` (
  ...
  `addressed_to` varchar(255) NOT NULL DEFAULT '—',
  `request_area` varchar(255) NOT NULL DEFAULT '—',
  PRIMARY KEY (`id`),
  KEY `approved_by_user_id` (`approved_by_user_id`),
...
INSERT INTO `material_requests` (`id`, `requester_user_id`, `approved_by_user_id`, `status`, `request_notes`, `approval_notes`, `rejection_reason`, `cancelled_notes`, `active`, `created_at`, `updated_at`, `addressee_name`, `addressee_title`, `addressed_to`, `request_area`) VALUES (1, 10, NULL, 'cancelled', NULL, NULL, NULL, 'Cancelado por solicitante', 1, '2026-04-29 18:14:51', '2026-04-29 19:42:51', '—', '—', '—', '—');
INSERT INTO `material_requests` (`id`, `requester_user_id`, `approved_by_user_id`, `status`, `request_notes`, `approval_notes`, `rejection_reason`, `cancelled_notes`, `active`, `created_at`, `updated_at`, `addressee_name`, `addressee_title`, `addressed_to`, `request_area`) VALUES (2, 10, 5, 'approved', NULL, 'Solicitud aprobada', NULL, NULL, 1, '2026-04-29 18:14:52', '2026-04-29 19:51:58', '—', '—', '—', '—');
INSERT INTO `material_requests` (`id`, `requester_user_id`, `approved_by_user_id`, `status`, `request_notes`, `approval_notes`, `rejection_reason`, `cancelled_notes`, `active`, `created_at`, `updated_at`, `addressee_name`, `addressee_title`, `addressed_to`, `request_area`) VALUES (3, 10, 5, 'cancelled', 'njkb', 'Solicitud aprobada', NULL, 'Cancelado por administrador', 1, '2026-04-29 18:16:11', '2026-04-29 19:51:55', '—', '—', '—', '—');
INSERT INTO `material_requests` (`id`, `requester_user_id`, `approved_by_user_id`, `status`, `request_notes`, `approval_notes`, `rejection_reason`, `cancelled_notes`, `active`, `created_at`, `updated_at`, `addressee_name`, `addressee_title`, `addressed_to`, `request_area`) VALUES (4, 10, NULL, 'cancelled', NULL, NULL, NULL, NULL, 1, '2026-04-29 19:33:40', '2026-04-29 19:33:47', '—', '—', '—', '—');
INSERT INTO `material_requests` (`id`, `requester_user_id`, `approved_by_user_id`, `status`, `request_notes`, `approval_notes`, `rejection_reason`, `cancelled_notes`, `active`, `created_at`, `updated_at`, `addressee_name`, `addressee_title`, `addressed_to`, `request_area`) VALUES (5, 12, 5, 'cancelled', 'Las computadoras en la nueva sección de informática son muy obsoletas.', 'Solicitud aprobada', NULL, 'Cancelado por administrador', 1, '2026-04-29 20:33:43', '2026-04-29 20:50:59', '—', '—', '—', '—');
INSERT INTO `material_requests` (`id`, `requester_user_id`, `approved_by_user_id`, `status`, `request_notes`, `approval_notes`, `rejection_reason`, `cancelled_notes`, `active`, `created_at`, `updated_at`, `addressee_name`, `addressee_title`, `addressed_to`, `request_area`) VALUES (6, 5, 5, 'approved', 'Necesidad de software nuevo.', 'Solicitud aprobada', NULL, NULL, 1, '2026-04-29 21:20:16', '2026-04-29 21:20:30', 'Maria Perez', 'Directora general', '—', 'Dirección general');
...
INSERT INTO `ticket_equipment` (`id`, `ticket_id`, `equipment_id`, `created_at`) VALUES (10, '79d70cd9-aa6e-46b1-b9e9-447b0662c647', 3, '2026-04-30 03:55:55');
