...
interface ConfirmDeleteEquipmentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export const ConfirmDeleteEquipmentModal: React.FC<ConfirmDeleteEquipmentModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  equipmentName,
              ...
              <div className="ml-4">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    ¿Estás seguro de que deseas eliminar el equipo <strong>"{equipmentName}"</strong>?
