  ...
  return (
    <div className="rounded-2xl p-6 mb-6 border border-sky-400/30 bg-gradient-to-br from-slate-900/70 via-sky-950/50 to-slate-900/70 backdrop-blur-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-xl p-4 bg-slate-900/55 border border-sky-400/25 backdrop-blur-sm">
          ...
          <div className="rounded-xl p-4 bg-slate-900/55 border border-sky-400/25 backdrop-blur-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-100">{user.phone}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="rounded-xl p-4 bg-slate-900/55 border border-sky-400/25 backdrop-blur-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-100">{user.department}</p>
              </div>
            </div>
          </div>
        )}
        <div className="rounded-xl p-4 bg-slate-900/55 border border-sky-400/25 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-slate-100">{translateRole(user?.role)}</p>
            </div>
          </div>
        </div>
      </div>
