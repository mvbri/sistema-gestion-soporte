...
interface ConfirmDeleteConsumableModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export const ConfirmDeleteConsumableModal: React.FC<ConfirmDeleteConsumableModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  consumableName,
              ...
              <div className="ml-4">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    ¿Estás seguro de que deseas eliminar el consumible <strong>"{consumableName}"</strong>?
