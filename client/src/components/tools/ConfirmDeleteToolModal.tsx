...
interface ConfirmDeleteToolModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  toolName: string;
...
export const ConfirmDeleteToolModal: React.FC<ConfirmDeleteToolModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  toolName,
              ...
              <div className="ml-4">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    ¿Estás seguro de que deseas eliminar la herramienta <strong>"{toolName}"</strong>?
