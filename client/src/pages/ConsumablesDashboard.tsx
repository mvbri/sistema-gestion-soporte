          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            <div className="mb-4 sm:mb-6 md:mb-8">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900">Dashboard de Consumibles</h1>
                </div>
              </div>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 ml-0 sm:ml-11">Vista general del inventario de consumibles</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-8">
              <div className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-gray-200 p-3 sm:p-4 md:p-6 hover:shadow-lg sm:hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-700 mb-1">Total de Consumibles</h3>
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-blue-600">{stats.total}</p>
                <p className="text-[10px] sm:text-xs md:text-sm text-gray-600 mt-1 sm:mt-2">Consumibles registrados</p>
              </div>
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-gray-200 p-3 sm:p-4 md:p-6 hover:shadow-lg sm:hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-700 mb-1">Stock Bajo</h3>
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-amber-600">{lowStockCount}</p>
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-gray-200 p-3 sm:p-4 md:p-6 hover:shadow-lg sm:hover:shadow-xl transition-shadow duration-300 sm:col-span-2 lg:col-span-1">
                ...
                <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-700 mb-1">Sin Stock</h3>
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-red-600">{outOfStockCount}</p>
                <p className="text-[10px] sm:text-xs md:text-sm text-gray-600 mt-1 sm:mt-2">Agotados</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
              <div className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-gray-200 p-3 sm:p-4 md:p-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 md:mb-6">
                  ...
                  <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800">Consumibles por Estado</h3>
                </div>
                {statusData.length > 0 ? (
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-gray-200 p-3 sm:p-4 md:p-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 md:mb-6">
                  ...
                  <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800">Consumibles por Tipo</h3>
                </div>
                {typeData.length > 0 ? (
                  <div className="w-full" style={{ height: 'clamp(250px, 30vh, 350px)' }}>
                    <ResponsiveContainer width="100%" height="100%">
